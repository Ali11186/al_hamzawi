...
class _ChargeScreenState extends State<ChargeScreen>
  ...
  Future<void> _charge() async {
    ...
    try {
      ...
      final price = double.tryParse(widget.card.netCharge) ?? 0.0;
      ...
      final resultMessage = (result['message'] ?? result['errorMessage'] ?? result['error']?['message'] ?? result['description'])?.toString();
